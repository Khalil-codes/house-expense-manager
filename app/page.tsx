...
import { PieChart, BarChart, Home, Building, Landmark, Download, Upload, Settings } from "lucide-react"
    ...
    reader.onload = (e) => {
      try {
        ...
        toast({
          ...
          description: "Your expense data has been imported from the JSON file.",
        })
      } catch (error) {
        toast({
          title: "Import failed",
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        <div className="w-full max-w-md mx-auto p-4">
          <h2 className="text-xl font-semibold mb-4 text-center">Loading House Expense Tracker</h2>
          <Progress value={40} className="h-2 mb-2" />
          <p className="text-sm text-center text-muted-foreground">Initializing application...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex flex-col space-y-6">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div className="space-y-2">
            <h1 className="text-3xl font-bold tracking-tight">House Expense Tracker</h1>
            <p className="text-muted-foreground">Track and manage all expenses related to your house project</p>
          </div>
