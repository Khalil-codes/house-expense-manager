...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-2 [--cell-radius:var(--radius)] [--cell-size:1.75rem] bg-background group/calendar",
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-sm"
            : "cn-calendar-caption-label rounded-[var(--cell-radius)] flex items-center gap-1 text-sm [&>svg]:text-muted-foreground [&>svg]:h-3.5 [&>svg]:w-3.5",
        ...
        today: cn(
          "bg-muted text-foreground rounded-[var(--cell-radius)] data-[selected=true]:rounded-none",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-primary data-[selected-single=true]:text-primary-foreground data-[range-middle=true]:bg-muted data-[range-middle=true]:text-foreground data-[range-start=true]:bg-primary data-[range-start=true]:text-primary-foreground data-[range-end=true]:bg-primary data-[range-end=true]:text-primary-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 dark:hover:text-foreground relative isolate z-10 flex aspect-square h-auto w-full min-w-[var(--cell-size)] flex-col gap-1 border-0 leading-none font-normal group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] data-[range-end=true]:rounded-[var(--cell-radius)] data-[range-end=true]:rounded-r-[var(--cell-radius)] data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-[var(--cell-radius)] data-[range-start=true]:rounded-l-[var(--cell-radius)] [&>span]:text-xs [&>span]:opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
