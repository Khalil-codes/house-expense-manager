...
export default function ConstructionExpenses() {
  ...
  const constructionTotal = construction.reduce(
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-base">Construction Expenses</CardTitle>
              <CardDescription className="text-xs">
                Total spent: ₹{constructionTotal.toLocaleString()}
              </CardDescription>
            </div>
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="max-w-[95vw] sm:max-w-md max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  <DialogTitle>
                    {editExpense ? "Edit" : "Add"} Construction Expense
                  </DialogTitle>
